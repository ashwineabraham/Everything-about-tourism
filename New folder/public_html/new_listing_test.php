							...
							<form name="register_now" action="add_listing.php" method="POST">
								<table>
									<tr>
										...
										<td><input class="i" type="text" size="45" name="business_name"></td>
									</tr>
																		
									<tr>
										<td><font face="arial" size="-1"><b>Country*</font></td>
										<td><select id="country"  type="text"  name="country"></select></td>
									</tr>
									<tr>
										<td><font face="arial" size="-1"><b>State/Region/Province</font></td>
										<td><select id="state" type="text" name="state"></select></td>
									</tr>
                                    <tr>
										<td><font face="arial" size="-1"><b>City or Town</font></td>
										<td><input class="i" type="text" size="15" name="city"></td>
									</tr>
                                    <tr>
										<td><font face="arial" size="-1"><b>Address</font></td>
										<td><input class="i" type="text" size="45" name="address"></td>
									</tr>
									<tr>
										<td><font face="arial" size="-1"><b>Zipcode/Postcode</font></td>
										<td><input class="i" type="text" size="10" name="postcode"></td>
									</tr>
									<tr>
										<td><font face="arial" size="-1"><b>Contact Person's Name*</font></td>
										<td><input class="i" type="text" size="45" name="contact"></td>
									</tr>
									<tr>
										<td><font face="arial" size="-1"><b>Phone*</font></td>
										<td><input class="i" type="text" size="15" name="phone"></td>
									</tr>
									<tr>
										<td><font face="arial" size="-1"><b>Mobile/Cellular*</font></td>
										<td><input class="i" type="text" size="15" name="mobile"></td>
									</tr>
									<tr>
										<td><font face="arial" size="-1"><b>Fax</font></td>
										<td><input class="i" type="text" size="15" name="fax"></td>
									</tr>
									<tr>
										<td><font face="arial" size="-1"><b>E-Mail*</font></td>
										<td><input class="i" type="text" size="45" name="email"></td>
									</tr>
									<tr>
										<td><font face="arial" size="-1"><b>Association No. if applicable</font></td>
										<td><input class="i" type="text" size="45" name="assoc_no"></td>
									</tr>
									<tr>
										<td><font face="arial" size="-1"><b>Website*</font></td>
										<td><input class="i" type="text" size="45" name="website"></td>
									</tr>
									<tr>
										<td><font face="arial" size="-1"><b>Website Description</font></td>
										<td><textarea class="i" type="text" rows="5" cols="35" name="website_desc"></textarea></td>
									</tr>
									<tr>
...
?>
										...
										<td colspan="2" align="right"><input class="btn" type="submit" value="Sign up Now!"></td>
									</tr>
								</table>
							</form>
						</td>
