    ...
    <style>
        ...
        * {
        ...
        body{
            margin: 0;
            padding: 0;
            background-image: URL( world-map.gif);
...
<?php
    if (isset($text)){
        ...
        echo ("<font face=arial size=-1 color=#ffffff><center>$text</font>");
        include ("red_end.inc");
        echo ("</td></tr>");
    }
    unset ($failure);
?>
                                    ...
                                    <tr><td><center><INPUT TYPE="image" SRC="login1.gif" BORDER="0"></td></tr>
                                </table>
                            </form>
                        </td>
                    </tr>
