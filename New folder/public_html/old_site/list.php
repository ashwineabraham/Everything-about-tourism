...
<table cellpadding="0" cellspacing="0" width="100%" height="100%">
    ...
    <tr>
        <td height="100%" class="stretch" valign="top">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td colspan="3"><img src="trans.gif" width="1" height="10"></td>
                </tr>
                <tr>
...
// using the SITEKEY variable grab a list of all matching categories sorted alphabetically
	...
	// echo ("<td bgcolor=\"#ffffff\" width=\"16\"></td>");
...
// on Peters request the rows are plain white however I kept the rotation code jsut in case
		...
		$tablerow="<tr><td width=\"350\" bgcolor=\"".$colour2."\"><font face=\"arial\" color=\"#ffffff\" size=\"-1\"><b>".$row2["providername"]."</font></td><td bgcolor=\"".$colour2."\"><font face=\"arial\" color=\"#ffffff\" size=\"-1\"><b>";
		...
		$tablerow=$tablerow."</font></td>";

		$query3=mysql_query("select website, online from website where providerid='".$row2["id"]."';");
		$row3 = mysql_fetch_row($query3);

		$tablerow=$tablerow."<td bgcolor=\"".$colour2."\"><font face=\"arial\" color=\"#ffffff\" size=\"-1\"><a href=\"http://".$row3[0]."\" target=\"_new\" style=\"text-decoration: none;\"><b>".$row3[0]." ".$row3[1]."</a></font></tr>\n";
...
<tr>
	<td colspan="4">
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td valign="top" align="left" width="200"><font color="yellow" size="-1"><b>Contact Us</font></td>
                <td valign="top" align="center" width="100%"></td>
                <td valign="top" align="right" width="200" ><font color="yellow" size="-1"><b>(c) <?php echo $site_title; ?></font></td>
            </tr>
            <tr>
