...
<tr>
	<td colspan="4">
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td colspan="3"><img src="images/images/trans.gif" width="1" height="10"></td>
            </tr>
            <tr>
                <td valign="top" align="left" width="200"><font color="yellow" size="-1"><b>Contact Us</b></font></td>
                <td valign="top" align="center" width="100%"></td>
                <td valign="top" align="right" width="200" ><font color="yellow" size="-1"><b>(c) <?php echo $site_title; ?></b></font></td>
            </tr>
            <tr>
