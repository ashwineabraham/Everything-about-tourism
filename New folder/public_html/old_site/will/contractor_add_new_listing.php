	...
	<table width="100%" height="100%" cellspacing="0">
  		<tr>
  			<td valign="top" width="35%">
  				<font face="arial" size="-1"><b>Instructions</b><p>To add a new provider you will need to enter in the details asked for on the roght of this screen.<p>You can choose up to five seperate categories however there is no requirement to choose more than one.<p><b>Note that the added provider will not be listed until approved.</b></font>
  			</td>
