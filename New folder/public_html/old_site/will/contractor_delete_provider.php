...
//		$provider_id=sanitize($_POST["site_id"]);
		...
		echo("update new_entries set site_deleted='pending', site_deleted_reason='".$reason."', site_deleted_time='".$time_now."' where id='".$provider_id."';");
