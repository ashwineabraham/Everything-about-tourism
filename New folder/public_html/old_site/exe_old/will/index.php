...
?>
                                ...
                                </select><img src="trans.gif" width="4" height="1"><input type="submit" value="Search" class="btn">
                            </form></center>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                           ...
                           <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="10%"></td>
                                    <td bgcolor="#000000" width="1"><img src="trans.gif" width="1" height="1"></td>
                                    <td width="10%" background="<?php echo $site_colour; ?>_top_small.gif"><img src="trans.gif" height="82" width="1"></td>
                                    <td bgcolor="#000000" width="1"><img src="trans.gif" width="1" height="1"></td>
                                    <td width="4%"></td>
                                    <td bgcolor="#000000" width="1"><img src="trans.gif" width="1" height="1"></td>
                                    <td width="10%" background="<?php echo $site_colour; ?>_top_small.gif"></td>
                                    <td bgcolor="#000000" width="1"><img src="trans.gif" width="1" height="1"></td>
                                    <td width="4%"></td>
                                    <td bgcolor="#000000" width="1"><img src="trans.gif" width="1" height="1"></td>
                                    <td width="10%" background="<?php echo $site_colour; ?>_top_small.gif"></td>
