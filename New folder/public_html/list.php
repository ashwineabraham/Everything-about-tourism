...
// increment the row counter
	...
	if(($rowcounter == 0) && ($country_name == null || $country_name == 'all' ) && ($category == null || $category == 'all')){
		echo  ("<center><font class='a'><i>Please Choose Country and Category!!!</b></i></font></center>");
		echo("<br>");
		echo("<br>");
		}
		else if (($rowcounter == 0) && ($country_name !== null || $country_name != 'all' ) && ($category == null || $category == 'all')){
