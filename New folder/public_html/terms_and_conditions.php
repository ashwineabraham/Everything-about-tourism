...
<!-- content column -->
			...
			<td valign="top">
				<table>
					<tr>
						<td><font class="pn" ><b><center>TERMS AND CONDITIONS</center></b><p>

                            <table>
                                <tr>
                                    <td colspan="3">
                                        <font>Below are the terms and conditions that govern use of the sites listed on the World Specialized Search Engines web sites by which you entered these or associated web sites...referred to herein as "the sites" and/or "these sites"<p>
                                        By using any of the Sites, you agree to be bound by these Terms and Conditions of Use (the "TCU") and our Privacy Policy (see below) and other usage guidelines and rules that may be displayed from time to time, all of which are incorporated herein by reference, and to follow the TCU and all applicable laws and regulations governing the sites.<p>
                                        If you do not agree, please do not enter or use the sites.
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        <font >The sites are not intended for use by persons under the age of thirteen. Individuals who are under thirteen are expressly prohibited from posting any personally identifiable information about themselves.</td>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        <font >Data and information relating to securities or otherwise is provided for informational purposes only and is not intended as advice or a recommendation for trading purposes.</td>
                                </tr>
                                <tr>
                                    <td colspan="3"><font >Please direct any questions you may have about the TCU, or any other legal matters, to the following e-mail address: <a href="mailto:manager@worldspecializedsearchengines.com">manager@worldspecializedsearchengines.com</td>
                                </tr>
                                <tr>
