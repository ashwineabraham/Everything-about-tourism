...
<!-- COUNTRY combo box -->
                            ...
                            <form name="index" action="test_2.php" method="POST" onSubmit="validate()" style='display:inline;'>

                              <select name="cboCountryCode" onchange="this.form.submit()" class="btn" >
...
?>
 ...
 <!-- Region combo box -->
                                <select name="region" class="btn" >
                                  <option value="none">
                                    <btn_txt>Choose State/Region</btn_txt>
                                  </option>
                                  <?php
...
// echo out the country list
        echo ("<option value=\"".$row["providerstatecode"]."\">".$row["providerstatecode"]."</option>\n");
