  ...
  input:required:valid {
    ...
    background-repeat: no-repeat;
		...
		select{
			...
			.btn {
            background: #75c8ff;
            background-image: -webkit-linear-gradient(top, #75c8ff, #17425c);
            background-image: -moz-linear-gradient(top, #75c8ff, #17425c);
            background-image: -ms-linear-gradient(top, #75c8ff, #17425c);
            background-image: -o-linear-gradient(top, #75c8ff, #17425c);
            background-image: linear-gradient(to bottom, #75c8ff, #17425c);
		...
		.btn:hover {
        background: #3cb0fd;
        background-image: -webkit-linear-gradient(top, #3cb0fd, #33678a);
        background-image: -moz-linear-gradient(top, #3cb0fd, #33678a);
        background-image: -ms-linear-gradient(top, #3cb0fd, #33678a);
        background-image: -o-linear-gradient(top, #3cb0fd, #33678a);
        background-image: linear-gradient(to bottom, #3cb0fd, #33678a);
        text-decoration: none;
}
...
?>
							...
							<table border="0">
								...
								<tr>
									<td valign="top"><font face="arial" size="-1"><b>Listing on all Top 20 Sites:</b><br>
									<td><img src="images/trans.gif" width="10" height="1"></td>
									<td valign="top"><font face="arial" size="-1"><b>US$39 Annual Registration Fee Ongoing</b></font></td>
									<td><img src="images/trans.gif" width="10" height="1"></td>
								</tr>
							</table><p>

							(Check your currency here: <a href="http://www.xe.com" target="_new">http://www.xe.com</a>) - if, at anytime you wish to cancel your ongoing annual listing, please advise us by email to 

				            <SCRIPT LANGUAGE="JavaScript" type="text/javascript">
				            gen_mail_to_link('cancel','worldfinancesearchengines.com','Cancelation Request')
				            </SCRIPT>
				            <NOSCRIPT>
				            <em>Email address protected by JavaScript. Activate javascript to see the email.</em>
				            </NOSCRIPT>

							and we will immediately cancel any annual payments and worldwide listings for you.<p>
							...
							...A Huge Saving for You Listing on All Top 20 Finance Sites Free of Charge via Payment to Any One of The Top 20 Search Directories at Only US39pa!<p>
...
?>
							...
							<font face="arial" size="-1">This is your point of entry to List Your Business and Web Site on This Search Engine, including 9 other Global Search Directories under This Topic, All for Only US$39 per annum for "The Top 10".<p>

							When you have completed Your Listing Details and made payment, Your Business will be automatically linked to All Associated Top 10 Global Search Directories.<p>
							...
							<table border="0">
								...
								<tr>
									<td valign="top"><font face="arial" size="-1"><b>Listing on all Top 10 Sites:</b><br>
									<td><img src="images/trans.gif" width="10" height="1"></td>
									<td valign="top"><font face="arial" size="-1"><b>US$39 Annual Registration Fee Ongoing</b></font></td>
									<td><img src="images/trans.gif" width="10" height="1"></td>
								</tr>
				            ...
				            <SCRIPT LANGUAGE="JavaScript" type="text/javascript">
				            gen_mail_to_link('cancel','worldspecializedsearchengines.com','Cancelation Request')
				            </SCRIPT>
				            <NOSCRIPT>
				            <em>Email address protected by JavaScript. Activate javascript to see the email.</em>
				            </NOSCRIPT>
							...
							For a Limited Time Only, Your Listing includes registrations on The World's Top 10 Specialized Search Engines under this Topic, plus up to 5 Categories if these are directly applicable to Your Business, completely free of charge, ongoing year after year if you wish to continue...<p>

							...A Huge Saving for You Listing on All Top 10 Sites Free of Charge via Payment to Any One of The Top 10 Global Search Directories at Only US39pa!<p>
...
?>
							...
							<font face="verdana" size="+1"><b>HOW TO PAY</font><p>
							...
							<form name="register_now" action="add_listing.php" method="POST" id="productForm" class="form-horizontal">
	
									<table>
                                   <tr>
   <div class="form-group">
       <td> <label class="col-xs-3 control-label">Business Name*</label></td>
        <div class="col-xs-3 inputGroupContainer">
            <div class="input-group">
               <td> <input type="text" class="form-control" size="45" name="business_name" id="business_name" required placeholder="Business Name Required" /></td>
            </div>
        </div>
    </div>
                                   </tr> 
                                   <tr>
    <div class="form-group">
       <td> <label class="col-xs-3 control-label">Country*</label></td>
        <div class="col-xs-3 selectContainer">
           <td> <select class="form-control" id="country"  type="text"  name="country" required  placeholder="Select Your Country" ></select></td>
        </div>
    </div>
                                   </tr>
                                   <tr>
    <div class="form-group">
       <td> <label class="col-xs-3 control-label">State/Region/Province*</label> </td>
        <div class="col-xs-3 selectContainer">
           <td> <select class="form-control" id="state"  type="text"  name="state" required ></select></td>
        </div>
    </div>
                                   </tr>
                                   <tr>
      <div class="form-group">
        <td><label class="col-xs-3 control-label">City or Town*</label></td>
        <div class="col-xs-3 inputGroupContainer">
            <div class="input-group">
                <td><input type="text" class="form-control" size="45" id="city" name="city" required placeholder="City/Town Required" /></td>
            </div>
        </div>
    </div>
                                   ...
                                   <tr>
    <div class="form-group">
        <td><label class="col-xs-3 control-label">Address</label></td>
        <div class="col-xs-3 inputGroupContainer">
            <div class="input-group">
                <td><input type="text" class="form-control" size="45" name="address" /></td>
            </div>
        </div>
    </div>
                                  </tr>
                                  <tr>
    <div class="form-group">
       <td> <label class="col-xs-3 control-label">Zipcode/Postcode</label></td>
        <div class="col-xs-3 inputGroupContainer">
            <div class="input-group">
                <td><input type="text" class="form-control" size="45" name="postcode" /></td>
            </div>
        </div>
    </div>
                                  </tr>
                                 <tr>
     <div class="form-group">
       <td> <label class="col-xs-3 control-label">Contact Person's Name*</label></td>
        <div class="col-xs-3 inputGroupContainer">
            <div class="input-group">
                <td><input type="text" class="form-control" size="45" id="contact" name="contact" required placeholder="Contact Person Name Required"/></td>
            </div>
        </div>
    </div>  
                                 </tr> 
                                  <tr>
    <div class="form-group">
        <td><label class="col-xs-3 control-label">Phone*</label></td>
        <div class="col-xs-3 inputGroupContainer">
            <div class="input-group">
                <td><input type="text" class="form-control" size="45" id="phone" name="phone" required placeholder="Phone Number Required" /></td>
            </div>
        </div>
    </div>
                                  </tr>
                                  <tr>
     <div class="form-group">
        <td><label class="col-xs-3 control-label">Mobile/Cellular</label></td>
        <div class="col-xs-3 inputGroupContainer">
            <div class="input-group">
                <td><input type="text" class="form-control" size="45" id="mobile" name="mobile" /></td>
            </div>
        </div>
    </div> 
                                  </tr>
                                  <tr>
   <div class="form-group">
       <td> <label class="col-xs-3 control-label">Fax</label></td>
        <div class="col-xs-3 inputGroupContainer">
            <div class="input-group">
                <td><input type="text" class="form-control" size="45" name="fax" /></td>
            </div>
        </div>
    </div>
                                  </tr>
                                  <tr>
   <div class="form-group">
       <td> <label class="col-xs-3 control-label">E-Mail*</label></td>
        <div class="col-xs-3 inputGroupContainer">
            <div class="input-group">
               <td> <input type="email"  class="form-control" size="45" name="email" id="email" required placeholder="E-mail Address Required" /></td>
            </div>
        </div>
    </div>
                                  </tr>
                                  <tr>
   <div class="form-group">
       <td> <label class="col-xs-3 control-label">Association No. if applicable</label></td>
        <div class="col-xs-3 inputGroupContainer">
            <div class="input-group">
               <td> <input type="text" class="form-control" size="45" name="assoc_no"  /></td>
            </div>
        </div>
    </div>
                                  </tr>
                                  <tr>
   <div class="form-group">
      <td>  <label class="col-xs-3 control-label">Website*</label></td>
        <div class="col-xs-3 inputGroupContainer">
            <div class="input-group">
               <td> <input type="text" class="form-control" size="45" id="website" name="website" required pattern="https?://.+" placeholder="Website Required" /></td>
            </div>
        </div>
    </div>
                                  </tr>
                                  <tr>
    <div class="form-group">
       <td> <label class="col-xs-3 control-label">Website Description</label></td>
        <div class="col-xs-3 inputGroupContainer">
            <div class="input-group">
               <td> <textarea type="text" class="form-control" rows="5" cols="15" name="website_desc"></textarea></td>
            </div>
        </div>
    </div>
                                  </tr>
									<tr>
										<td><label class="col-xs-3 control-label">Category*</label></td>
...
//	include ("dbconnect.php");
	...
	for ($counter=1;$counter<6;$counter++){
		...
		echo ("<input type=\"hidden\" name=\"site_category\" value=\"".$site."\">");
...
?>
										...
										<td colspan="2" align="center"><input class="btn" type="submit" onclick = "return validatenewuser(document)" value="Sign up Now!"></td>
									</tr>
								</table>
							</form>
						</td>
...
<!-- right column -->
	...
	function validatenewuser(document)
{
	var bname=document.getElementById("business_name");
	var country=document.getElementById("country");
	var state=document.getElementById("state");
	var cpname=document.getElementById("contact");
	var phone=document.getElementById("phone");
	var city=document.getElementById("city");
	var email=document.getElementById("email");
	var website=document.getElementById("website");
	
if (bname.value=="" && country.value=="" && state.value=="" && cpname.value=="" && phone.value=="" && city.value=="" && email.value=="" && website.value=="" )
{
	alert ("Please Fill in the Required Feilds to Register");
	return false;
}
if (bname.value=="")
{
        ...
        fields: {
           business_name: {
            ...
            contact: {
                validators: {
                    notEmpty: {
                        message: "The Contact Person's Name is required"
                    }
                }
            },
            phone: {
